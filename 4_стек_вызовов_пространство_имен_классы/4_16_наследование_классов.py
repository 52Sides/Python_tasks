...
какую-то информацию при обращении к методам класса, Рассмотрим класс Loggable:
import time
...
Примечание: Ваша программа не должна содержать класс Loggable. При проверке вашей
программе будет доступен этот класс, и он будет содержать метод log, описанный выше.
"""
...
class LoggableList(list, Loggable):
    ...
    def append(self, msg):
        self.log(msg)
        return super(LoggableList, self).append(msg)
