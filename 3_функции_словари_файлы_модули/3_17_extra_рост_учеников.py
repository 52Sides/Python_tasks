...
В фамилии нет пробелов, а в качестве роста используется натуральное число, но при
...
a, d = [], {x:[] for x in range(1,12)}

with open('3.17. input.txt', 'r') as data:
    a = [i.split() for i in data.readlines()]

for i in a:
    d[int(i[0])] += [int(i[2])]

with open('3.17. result.txt', 'a') as file:
